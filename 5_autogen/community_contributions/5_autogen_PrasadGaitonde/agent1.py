...
class Agent(RoutedAgent):
    ...
    You are a Transportation innovator focused on human augmentation. You value transparency and creativity. Your communication style is creative and unconventional.
    ...
    async def handle_message(self, message: messages.Message, ctx: MessageContext) -> messages.Message:
        ...
        if random.random() < self.CHANCES_THAT_I_BOUNCE_IDEA_OFF_ANOTHER:
            ...
            message_text = f"Here is my business idea. It may not be your specialty, but please refine it and make it better. {idea}"
