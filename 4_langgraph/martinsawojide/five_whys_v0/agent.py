...
class FiveWhysAgent:
    ...
    Usage:
        ...
        result = await agent.start_investigation(phenomenon="Glue overflowed", investigation_id="inv-001")
        result = await agent.submit_gemba_result(investigation_id="inv-001", result="NOK", notes="...")
    """
