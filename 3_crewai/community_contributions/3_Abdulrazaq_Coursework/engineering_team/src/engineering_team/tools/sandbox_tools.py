...
def reset_sandbox() -> None:
    ...
    # Write pyproject.toml directly instead of calling `uv init` / `uv add`.
    # Those commands sync the parent workspace venv, which fails on Windows
    # while this crew process is running from that venv.
    (SANDBOX_DIR / "pyproject.toml").write_text(SANDBOX_PYPROJECT)
